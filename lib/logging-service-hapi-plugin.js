...
module.exports.register = function(plugin, options, next) {
	...
	var logger = log4js.getLogger('runrightfast-logging-service');

	var configureLogging = function(logLevel) {
		var validLogLevels = [ 'DEBUG', 'INFO', 'WARN', 'ERROR' ];
		assert(lodash.isString(logLevel) && lodash.contains(validLogLevels, logLevel.toUpperCase()),
