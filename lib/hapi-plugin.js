...
module.exports.register =
		function(plugin, options, next) {
			...
			// functions are not handled by Hoek.applyToDefaults - need to copy
			// over
			// manually
			...
			if (lodash.isObject(settings.loggingService)) {
				assert(lodash.isFunction(settings.loggingService.log),
						"loggingService must contain a function named log : settings.loggingService.log type is [" + (typeof settings.loggingService.log) + ']');
